...
# Starts a single validator instance
...
VALIDATOR_CMD="python validator.py --chain=\"ws://localhost:$CHAIN_PORT\" --ollama=\"http://localhost:$OLLAMA_PORT\" --interval=$VALIDATION_INTERVAL"
if [ -n "$REGISTER_FLAG" ]; then
